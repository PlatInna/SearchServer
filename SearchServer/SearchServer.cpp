...
/* SearchServer.cpp : https://www.coursera.org/ Îñíîâû ðàçðàáîòêè íà C++: êðàñíûé ïîÿñ, Íåäåëÿ 6. Ôèíàëüíàÿ çàäà÷à
Çàäàíèå ïî ïðîãðàììèðîâàíèþ: Ïîèñêîâàÿ ñèñòåìà
*/
...
void SearchServer::UpdateDocumentBase(istream& document_input) {
    ...
    //index = move(new_index); // ïîñëåäîâàòåëüíî áåç îáåðòêè Synchronized<InvertedIndex>;
}
